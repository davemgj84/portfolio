...
const projectData = [
  ...
  },
  {
    id: 2,
    title: "Wiki-Maps",
    desc: "An interactive map where users can create personal maps of favourite locations, using the Google Maps API.",
  ...
  },
  {
    id: 3,
    title: "Scheduler",
    desc: "Scheduler is single-page app that allows students to book appointments with interviewers.",
  ...
  },
  {
    ...
    tech: "React, React-Router, React-Spring, GSAP, Phaser, Axios, Express, Node & PSQL",
    image: sapphire,
  ...
  },
  {
    id: 5,
    title: "Haiku",
    desc: "A small but fun Front-End application, that will allows the user to click a button and read a Haiku. Every click will bring up a new Haiku.",
  ...
  },
  {
    id: 6,
    title: "Film Awards",
    desc: "An app that allows users to search the Open Movie Database (OMDb API), for their favourite films and nominate up to 5 films for an award.",
    icon: "fas fa-film",
  ...
  },
  {
    id: 7,
    title: "Weather",
    desc: "A simple Front-End Weather Application. Using the OpenWeather API, it provides real time weather data to the user.",
  ...
  },
  {
    id: 8,
    title: "React Blog",
    desc: "A simple Blog in which a user may read, create, or delete blog articles.",
    icon: "fab fa-react",
  ...
  },
  {
    id: 9,
    title: "ISS Spotter",
    desc: "An app for space enthusiasts who are interested in spotting the International Space Station (ISS).",
